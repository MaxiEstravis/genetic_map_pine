## downloaded on 2025-04-24 from https://github.com/parkingvarsson/HaploidSpruceMap/blob/master/map_analysis/omicCircos.R
...
read.table("./Consensus_maps_SPRUCE.txt",head=T)->maps
